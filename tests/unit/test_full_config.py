...
from tests.unit.config_model import AnyEnum, FlatConfig, RootConfig
...
def config_dict(tmp_path: str):
    return {
        "rootValue": 1,
        "rangeValue": 5,
        "childNode": {"testStr": "This is a test", "testInt": 42, "testFloat": 42.42, "anyEnum": "value2"},
    }
...
def test_load_flat_config(flat_config_yaml: str):
    ...
    logging.info(f"Config loaded: {flat_config.model_dump()}")
